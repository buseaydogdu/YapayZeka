...
try: nltk.find('tokenizers/punkt') # yoksa download et.
except LookupError: nltk.download('punkt')
try: nltk.find('stopwords') # yoksa download et.
...
# print(" Cümleler:",cumleler); # print(" Kelime listesi: ",kelimeler)
...
temizlenmis_liste = []
# print(" Stop words:",stop_words); print("Stop words Türkçe:",stop_words_tr)
...
print(" Etiketlenmiş kelimeler: ",nltk.pos_tag(kelimeler)) 
